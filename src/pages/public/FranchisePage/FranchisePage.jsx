        ...
        <div className="grid grid-cols-5 gap-4 py-10">
          <div className="col-span-3 p-4 text-justify">
            <p>
              ...
              nỗ lực kiện toàn. 
              <br/>
              Hơn ai hết, chúng tôi hiểu rằng sự thành công
              còn đến từ sự hợp tác với các đối tác xuất sắc - những người có
              cùng đam mê, cùng khát vọng vươn lên, nâng cao giá trị bản thân.
              Nếu bạn quan tâm đến việc trở thành một đối tác, hoặc chỉ muốn
              biết thêm về Fresh Garden, hãy đọc tiếp và chúng tôi sẽ tiếp tục
              kể cho bạn nghe một chút câu chuyện về bản thân chúng tôi, thương
              hiệu của chúng tôi, và quá trình tìm kiếm những người mà chúng tôi
              mong muốn hợp tác. 
              <br/>
              Chúng tôi là sự khác biệt trong những thứ tốt nhất! 
              <br/>
              Trên hết, Fresh Garden là một thương hiệu phổ biến nhất về
              việc làm ra các sản phẩm bánh tuyệt vời và chất lượng như bánh mỳ
              tươi, bánh kem, bánh mỳ nướng… Chinh phục những khách hàng khó
              tính nhất bởi sự đa dạng trong chủng loại bánh, tinh tế từ kiểu
              dáng đến tỷ mỉ trong khâu chọn lựa nguyên liệu. 
              <br/>
              Các thợ làm bánh của chúng tôi luôn làm việc trong một môi trường thân thiện, vui
              vẻ và hạnh phúc từ đó tạo ra những chiếc bánh gửi gắm sự yêu
              thương đến với khách hàng, mang lại sự trải nghiệm đầy hứng khởi
              mỗi khi đến với Fresh Garden. 
              <br/>
              Mỗi một cửa hàng của chúng tôi sẽ
              mang đến cho khách hàng một câu chuyện thú vị, sự ấm cúng, gần gũi
              trong không gian, tiện ích trong mọi góc phố để tạo ra những điểm
              chạm trên hành trình sử dụng của khách hàng và đương nhiên, luôn
              có sự phục vụ chuyên nghiệp đồng nhất trên toàn hệ thống. 
              <br/>
              Khách
              hàng của chúng tôi đa dạng về văn hóa và lứa tuổi, phổ biến là học
              sinh, sinh viên và nhân viên văn phòng trẻ, chúng tôi còn được yêu
              thích bởi các gia đình đến những người nổi tiếng, tất cả đều chia
              sẻ tình yêu đối với những chiếc bánh tươi ngon chất lượng của một
              thương hiệu uy tín
            </p>
          </div>
          <div className="col-span-2 p-4 flex items-center justify-center text-center">
            <h1 className="text-5xl font-semibold font-playfairDisplay">Chúng tôi là sự khác biệt<br/>trong những thứ tốt nhất!</h1>
          </div>
          <img
