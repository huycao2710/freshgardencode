...
const ProductList = () => {
  ...
  const mutationUpdate = useMutationHooks((data) => {
    ...
    const res = ProductAllService.updateInfoProduct(id, token, { ...rests });
    return res;
  });

  const mutationDeleted = useMutationHooks((data) => {
    const { id, token } = data;
    const res = ProductAllService.deleteInfoProduct(id, token);
    return res;
  });

  const mutationDeletedMany = useMutationHooks((data) => {
    const { token, ...ids } = data;
    const res = ProductAllService.deleteManyProduct(ids, token);
    return res;
  });
  ...
  const dataTable =
    ...
    products?.data?.map((product) => {
      return {
        ...product,
        key: product._id,
        featured: product.featured ? "Sản phẩm nổi bật" : "Không",
        ...
        <Loading isPending={isPending}>
          ...
          >
            ...
            <Form.Item
              ...
              name="imageProduct"
              rules={[
                { required: false, message: "Vui lòng nhập ảnh sản phẩm!" },
              ]}
            >
      ...
      >
        <Loading isPending={isPendingUpdate || isPendingUpdated}>
          ...
          >
            ...
            >
              <InputComponent
                value={stateProductDetails["nameProduct"]}
            ...
            >
              <InputComponent
                value={stateProductDetails["categoryName"]}
                onChange={handleOnchangeDetails}
                name="categoryName"
              />
            </Form.Item>
            ...
            >
              ...
              >
                ...
                {stateProductDetails?.imageProduct && (
                  <img
                    src={stateProductDetails?.imageProduct}
                    style={{
                      height: "60px",
                      width: "60px",
                      borderRadius: "50%",
            ...
            >
              <Radio.Group
                ...
                value={stateProductDetails.featured}
              >
            ...
            >
              <Radio.Group
                ...
                value={stateProductDetails.available}
              >
