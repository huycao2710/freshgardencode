                        ...
                        <Grid container spacing={2}>
                            <Grid item xs={8}>
                                <Stack spacing={2} direction="row">
                                    <Card sx={{ minWidth: 49.25 + "%", height: 150 }} className="gradient">
                                        <CardContent>
                                    ...
                                    <Card sx={{ minWidth: 49.25 + "%", height: 150 }} className="gradientlight">
                                        <CardContent>
                                            <div className="iconStyle">
                                                <ShoppingBag />
                                            </div>
                                    ...
                                    <Card className="gradientlight">
                                        <Stack spacing={2} direction="row">
                                            ...
                                            <div className="paddingAll">
                                                <span className="priceTitle">$<CountUp delay={0.4} end={200000} duration={0.6} /></span>
                                                <br />
